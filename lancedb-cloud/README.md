...
2. Instruction for applying $50 credit for LanceDB Cloud can be found [here](https://docs.google.com/forms/d/e/1FAIpQLScDxl3IlVhL_hlV3lmOB74DDP_tpZZ7y1xdfyKkpx0SXNs4Qw/viewform), please fill the form to get the credit. 
3. Set the GMI Cloud API key and LanceDB project API key env variables.
